...
public enum PersistedBmmSchemaState implements Serializable {
    ...
    STATE_INCLUDES_PENDING, //State of schema processing if there are still included schemas to process
    STATE_INCLUDES_PROCESSED //State when all included schemas have been processed
}
