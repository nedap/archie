...
/**
 * Serializer for BmSinglePropertyOpen.
 *
...
public class BmmSinglePropertyOpenSerializer extends BaseBmmSerializer<PersistedBmmSinglePropertyOpen> {
     ...
     * @param property
     */
    public BmmSinglePropertyOpenSerializer(PersistedBmmSinglePropertyOpen property) {
        super(property);
    }
    ...
    public void serialize(int indentationCount, StringBuilder builder) {
        ...
        indentByAndAppend(builder, indentCount, OdinSerializationUtils.buildKeyedObjectOpeningDeclarationWithCast(getPersistedModel().getName(), PersistedBmmSinglePropertyOpen.P_BMM_SINGLE_PROPERTY_OPEN));
        ++indentCount;
