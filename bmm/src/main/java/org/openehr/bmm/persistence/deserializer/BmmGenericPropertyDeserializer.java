...
public class BmmGenericPropertyDeserializer extends BmmPropertyDeserializer {
    public PersistedBmmGenericProperty deserialize(CompositeOdinObject propertyDefinition) {
        ...
        PersistedBmmGenericProperty property = new PersistedBmmGenericProperty();
        property.setDocumentation(documentation);
        String propertyName = propertyDefinition.getAttribute(BmmConstants.BMM_PROPERTY_NAME).getStringValue();
        ...
        PersistedBmmGenericType persistedBmmGenericType = deserializer.deserialize(typeDefAttribute.getSoleCompositeObjectBody());
        ((PersistedBmmGenericProperty)property).setTypeDefinition(persistedBmmGenericType);
