...
If you want to depend on just the AOM and BMM, without any reference model implementation, depend on com.nedap.healthcare.archie:tools:0.5.6 and com.nedap.healthcare.archie:referencemodels:0.5.6 instead
