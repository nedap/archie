...
```gradle
dependencies {
    compile 'com.nedap.healthcare.archie:archie-all:0.4.1'
}
```
...
If you want to depend on just the AOM and BMM, without any reference model implementation, depend on com.nedap.healthcare.archie:tools:0.4.1 and com.nedap.healthcare.archie:referencemodels:0.4.1 instead
