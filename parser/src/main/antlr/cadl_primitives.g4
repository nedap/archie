...
c_date: ( ISO8601_DATE | date_value | date_list_value | date_interval_value | date_interval_list_value ) ( ';' assumed_date_value )? ;
assumed_date_value: date_value;

c_time: ( ISO8601_TIME | time_value | time_list_value | time_interval_value | time_interval_list_value ) ( ';' assumed_time_value )? ;
assumed_time_value: time_value;

c_date_time: ( ISO8601_DATE_TIME | date_time_value | date_time_list_value | date_time_interval_value | date_time_interval_list_value ) ( ';' assumed_date_time_value )? ;
